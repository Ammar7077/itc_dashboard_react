...
const CardDataFolder: React.FC<CardDataFolderProps> = ({
  title,
  Size,
  NoOfFiles,
  levelUp,
  ...
  return (
    <div className="rounded-lg border border-stroke bg-white py-6 px-7.5 shadow-default dark:border-strokedark dark:bg-boxdark">
      <div className="flex h-11.5 w-15 items-center justify-center rounded-full bg-meta-2 dark:bg-meta-4">
        {children}
      </div>
