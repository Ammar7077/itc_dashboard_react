...
import Logo from '../../images/logo/itc_logo.png';
import consulting from '../../images/sideBar/consultation.png';
import media from '../../images/sideBar/bullhorn.png';
import json from '../../images/sideBar/code.png';
              ...
              <SidebarLinkGroup activeCondition={pathname === '/'}>
                {(handleClick, open) => (
                  <React.Fragment>
                    ...
                    <NavLink
                      to="#"
                      className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4  hover:text-blue-600 ${(pathname === '/') &&
                    ...
                    >
                      ...
                      <span className='text-white hover:text-blue-600'>Databank</span>
                      <svg
                    ...
                    >
                      <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                        <SidebarLinkGroup activeCondition={pathname.includes('ai')}>
                          {(handleClick, open) => (
                            <React.Fragment>
                              <NavLink
                                to="data/ai"
                                className={` group relative flex bg-graydark text-white items-center gap-2.5 rounded-sm px-4 py-2 font-medium ${(pathname === '/data/ai' ||
    ...
    >
      <g data-name="Product Icons">
        ...
        />
                        ...
                        <SidebarLinkGroup activeCondition={pathname.includes('consulting')}>
                          {(handleClick, open) => (
                            <React.Fragment>
                              <NavLink
                                to="data/consultings"
                                className={` group relative bg-graydark text-white flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium duration-300 ease-in-out hover:bg-meta-4 hover:text-black ${(pathname === '/data/consultings' ||
    ...
    >
      <g transform="translate(1 1)">
        ...
        <g>
          ...
          <path style={{ fill: '#0096E6' }} d="M255,451.267c-5.12,0-8.533-3.413-8.533-8.533v-25.6c0-5.12,3.413-8.533,8.533-8.533 s8.533,3.413,8.533,8.533v25.6C263.533,447.853,260.12,451.267,255,451.267z" />
        </g>
        ...
        <g>
          ...
          <path style={{ fill: '#0096E6' }} d="M152.6,169.667c0,5.12,3.413,8.533,8.533,8.533c5.12,0,8.533-3.413,8.533-8.533 c0-5.12-3.413-8.533-8.533-8.533C156.013,161.133,152.6,164.547,152.6,169.667" />
          <path style={{ fill: '#0096E6' }} d="M502.467,425.667H7.533c-5.12,0-8.533-3.413-8.533-8.533s3.413-8.533,8.533-8.533h494.933 c5.12,0,8.533,3.413,8.533,8.533S507.587,425.667,502.467,425.667z" />
          <path style={{ fill: '#0096E6' }} d="M186.733,169.667c0,5.12,3.413,8.533,8.533,8.533c5.12,0,8.533-3.413,8.533-8.533 c0-5.12-3.413-8.533-8.533-8.533C190.147,161.133,186.733,164.547,186.733,169.667" />
          <path style={{ fill: '#0096E6' }} d="M169.667,186.733c0,5.12,3.413,8.533,8.533,8.533c5.12,0,8.533-3.413,8.533-8.533 c0-5.12-3.413-8.533-8.533-8.533C173.08,178.2,169.667,181.613,169.667,186.733" />
          <path style={{ fill: '#0096E6' }} d="M152.6,203.8c0,5.12,3.413,8.533,8.533,8.533c5.12,0,8.533-3.413,8.533-8.533 c0-5.12-3.413-8.533-8.533-8.533C156.013,195.267,152.6,198.68,152.6,203.8" />
          <path style={{ fill: '#0096E6' }} d="M186.733,203.8c0,5.12,3.413,8.533,8.533,8.533c5.12,0,8.533-3.413,8.533-8.533 c0-5.12-3.413-8.533-8.533-8.533C190.147,195.267,186.733,198.68,186.733,203.8" />
          <path style={{ fill: '#0096E6' }} d="M169.667,220.867c0,5.12,3.413,8.533,8.533,8.533c5.12,0,8.533-3.413,8.533-8.533 c0-5.12-3.413-8.533-8.533-8.533C173.08,212.333,169.667,215.747,169.667,220.867" />
        </g>
        <g>
          <path style={{ fill: '#0096E6' }} d="M169.667,237.933c0,5.12,3.413,8.533,8.533,8.533c5.12,0,8.533-3.413,8.533-8.533 c0-5.12-3.413-8.533-8.533-8.533C173.08,229.4,169.667,232.813,169.667,237.933" />
        </g>
      </g>
    </svg>
                        ...
                        <SidebarLinkGroup activeCondition={pathname.includes('media')}>
                          {(handleClick, open) => (
                            <React.Fragment>
                              <NavLink
                                to="data/media"
                                className={` group relative bg-graydark text-white flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium duration-300 ease-in-out hover:bg-meta-4 hover:text-black ${(pathname === '/data/media' ||
                        ...
                        <SidebarLinkGroup activeCondition={pathname.includes('json')}>
                          {(handleClick, open) => (
                            <React.Fragment>
                              <NavLink
                                to="data/JSONLs"
                                className={` group relative flex text-white items-center gap-2.5 rounded-sm px-4 py-2 font-medium duration-300 bg-graydark  ease-in-out hover:bg-meta-4 hover:text-black ${(pathname === '/data/JSONLs' ||
