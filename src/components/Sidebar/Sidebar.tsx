                        ...
                        >
                          {(handleClick, open) => (
                            <React.Fragment>
                              <NavLink
                                to="data/ai"
                                className={`group relative bg-graydark flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium duration-300 ease-in-out hover:bg-meta-4 hover:text-black ${
                                  pathname === "/data/ai"
                                    ? "bg-white text-blue-700 dark:bg-meta-4" // Apply bg-white and text-blue-700 if active
                                    : "text-white"
                                }`} // Apply text-white only if not active
                                onClick={handleClick}
                              >
                                <svg
                                  height="800px"
